...
// 'catdog' was typed
export function handleBackspaceWithOverflow(cursor, letters, container, counters) {
...
export function handleBackspaceWithoutOverflow(cursor, counters, letters, container) {
    counters.input = counters.input.slice(0, -1)
...
export function handleCorrectCharacter(cursor, counters, letters, container, key) {
...
export function handleExpectedSpaceCharacter(cursor, counters, word, letters, container) {
...
export function handleUnexpectedSpaceCharacter(cursor, counters, word, letters, container) {
    cursor.moveCursorToNextWord(letters, container, word.text.length, counters.input.length)
...
export function handleWrongInputCharacter(cursor, counters, letters, container, key) {
    counters.input = counters.input + key
